...
DEFINE_bool(use_band_bird, false, "use audio len vs transcription len beak band filtering");
DEFINE_bool(use_band_bird_ls, false, "use audio len vs transcription len beak band filtering for LS setting");
